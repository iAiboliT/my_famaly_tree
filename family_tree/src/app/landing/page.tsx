...
export default function LandingPage() {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden bg-white dark:bg-gray-950 font-sans">
            {/* Background Image - The Oak Tree */}
            <div
                className="absolute inset-0 opacity-10 dark:opacity-5 pointer-events-none bg-center bg-no-repeat bg-cover"
                style={{ backgroundImage: 'url("/artifacts/oak_tree_background.svg")' }}
            />
