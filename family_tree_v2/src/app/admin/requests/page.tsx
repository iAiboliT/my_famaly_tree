        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-8">
            <div className="max-w-4xl mx-auto space-y-8">
                <header className="flex justify-between items-center">
                    ...
                    <Link href="/trees" className="px-6 py-2 bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-xl font-bold text-xs">
                        Вернуться к списку
                    </Link>
                </header>
                                ...
                                <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                        ...
                                        <h4 className="font-bold dark:text-white">
                                            {req.requester.email} {req.targetModel === 'ACCESS_REQUEST' ? 'запросил(а) доступ к дереву' : `предложил(а) ${req.type === 'CREATE' ? 'создать' : req.type === 'UPDATE' ? 'изменить' : 'удалить'} запись`}
                                        </h4>
