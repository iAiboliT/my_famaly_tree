    ...
    return (
        <div className="fixed inset-0 z-[100] bg-transparent backdrop-blur-3xl animate-in fade-in zoom-in duration-300 flex flex-col">
            ...
            <div className="flex justify-between items-center px-8 py-4 border-b border-indigo-100/30 dark:border-gray-800/30 shrink-0 shadow-sm relative z-10">
                ...
                <div className="flex items-center gap-4">
                    <button onClick={onClose} className="p-2 hover:bg-rose-50 dark:hover:bg-rose-900/20 text-rose-500 rounded-xl transition-all border border-transparent hover:border-rose-200">
            ...
            <div className="px-4 md:px-8 py-4 border-t border-indigo-100/30 dark:border-gray-800/30 flex flex-wrap justify-between items-center gap-4 bg-white/40 dark:bg-gray-950/40 backdrop-blur-md shrink-0">
                <button onClick={onClose} className="flex-1 md:flex-none px-4 md:px-10 py-3 md:py-4 bg-white/50 dark:bg-gray-800/50 text-gray-400 font-black text-sm md:text-xl hover:text-rose-500 rounded-xl md:rounded-2xl border border-white dark:border-white/10 flex items-center justify-center gap-2 md:gap-3 transition-all">
                    <X size={20} className="md:w-6 md:h-6" /> <span className="hidden xs:inline">Закрыть</span>
                </button>
                <div className="flex flex-1 md:flex-none gap-2 md:gap-4">
                    <button onClick={handleDelete} className="flex-1 md:flex-none px-4 md:px-10 py-3 md:py-4 bg-rose-50 text-rose-600 hover:bg-rose-600 hover:text-white rounded-xl md:rounded-2xl font-black text-sm md:text-xl flex items-center justify-center gap-2 md:gap-3 transition-all border-2 border-rose-100">
                        <Trash2 size={20} className="md:w-6 md:h-6" /> <span className="hidden xs:inline">Удалить</span>
                    </button>
                    <button
                        onClick={() => {
                            const params = new URLSearchParams(window.location.search);
                        ...
                        className="flex-[2] md:flex-none px-6 md:px-16 py-3 md:py-4 bg-indigo-600 text-white rounded-xl md:rounded-2xl font-black text-sm md:text-xl flex items-center justify-center gap-2 md:gap-4 transition-all hover:bg-indigo-700 shadow-xl shadow-indigo-500/20"
                    >
                        <Edit3 size={20} className="md:w-6 md:h-6" /> Изменить
                    </button>
                </div>
            </div>
